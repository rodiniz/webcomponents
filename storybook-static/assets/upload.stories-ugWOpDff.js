import{r as m,a as v,i as b,b as o}from"./iframe-6s-sIqo3.js";import{n,t as $}from"./property-C_0pZ1Mq.js";import{r as g}from"./state-vQ8fJvXj.js";import{c as y}from"./template-BbtPzLcA.js";import{t as D}from"./theme-CCP9F1YV.js";import"./preload-helper-C1FmrZbK.js";import"./unsafe-html-BsqWkz84.js";var C=Object.defineProperty,F=Object.getOwnPropertyDescriptor,a=(e,s,t,r)=>{for(var l=r>1?void 0:r?F(s,t):s,d=e.length-1,h;d>=0;d--)(h=e[d])&&(l=(r?h(s,t,l):h(l))||l);return r&&l&&C(s,t,l),l};let i=class extends b{constructor(){super(...arguments),this.accept="",this.multiple=!1,this.disabled=!1,this.label="Drag and drop files here",this.helper="",this.name="",this.files=[],this.isDragging=!1,this.handleDragOver=e=>{e.preventDefault(),this.disabled||(this.isDragging=!0)},this.handleDragLeave=e=>{e.preventDefault(),this.isDragging=!1},this.handleDrop=e=>{var t;if(e.preventDefault(),this.isDragging=!1,this.disabled)return;const s=(t=e.dataTransfer)==null?void 0:t.files;s&&this.processFiles(Array.from(s))},this.handleInputChange=e=>{const s=e.target;s.files&&this.processFiles(Array.from(s.files))}}connectedCallback(){this.setAttribute("data-ui","upload"),super.connectedCallback()}get value(){return this.files.map(e=>e.name).join(", ")}get filesValue(){return this.files}set filesValue(e){this.setFiles(e)}clear(){this.files=[]}setFiles(e){this.files=e,this.dispatchEvent(new CustomEvent("files-change",{detail:{files:this.files},bubbles:!0,composed:!0}))}processFiles(e){let s;this.multiple?s=[...this.files,...e]:s=e,this.files=s,this.dispatchEvent(new CustomEvent("files-change",{detail:{files:s},bubbles:!0,composed:!0}))}removeFile(e){this.files=this.files.filter((s,t)=>t!==e),this.dispatchEvent(new CustomEvent("files-change",{detail:{files:this.files},bubbles:!0,composed:!0}))}render(){const e=y({upload:!0,dragging:this.isDragging,disabled:this.disabled,"has-files":this.files.length>0});return o`
